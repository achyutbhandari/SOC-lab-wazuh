🛡️ Security Operations Home Lab – Wazuh SIEM
📌 Project Overview
...
1️⃣ Wazuh Manager Installation (Ubuntu)
...
________________________________________
3️⃣ Windows Agent Installation
...
1️⃣ SSH Brute Force (Linux Agent)
Command from Kali:
